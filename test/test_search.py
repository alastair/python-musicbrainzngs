...
class SearchUrlTest(_common.RequestsMockingTestCase):
    ...
    def test_search_annotations(self):
        ...
        self.assertEquals("http://musicbrainz.org/ws/2/annotation/?query=Pieds", self.last_url)
        ...
        self.assertEquals(expected, self.last_url)
    ...
    def test_search_artists(self):
        ...
        self.assertEqual("http://musicbrainz.org/ws/2/artist/?query=Dynamo+Go", self.last_url)
    ...
    def test_search_events(self):
        ...
        self.assertEqual("http://musicbrainz.org/ws/2/event/?query=woodstock", self.last_url)
    ...
    def test_search_labels(self):
        ...
        self.assertEqual("http://musicbrainz.org/ws/2/label/?query=Waysafe", self.last_url)
    ...
    def test_search_places(self):
        ...
        self.assertEqual("http://musicbrainz.org/ws/2/place/?query=Fillmore", self.last_url)
    ...
    def test_search_releases(self):
        ...
        self.assertEqual("http://musicbrainz.org/ws/2/release/?query=Affordable+Pop+Music", self.last_url)
    ...
    def test_search_release_groups(self):
        ...
        self.assertEqual("http://musicbrainz.org/ws/2/release-group/?query=Affordable+Pop+Music", self.last_url)
    ...
    def test_search_recordings(self):
        ...
        self.assertEqual("http://musicbrainz.org/ws/2/recording/?query=Thief+of+Hearts", self.last_url)
    ...
    def test_search_works(self):
        ...
        self.assertEqual("http://musicbrainz.org/ws/2/work/?query=Fountain+City", self.last_url)
