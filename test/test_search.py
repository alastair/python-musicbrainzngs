...
class SearchUrlTest(_common.RequestsMockingTestCase):
    ...
    def test_search_annotations(self):
        ...
        expected = f'https://musicbrainz.org/ws/2/annotation/?query={quote_plus(expected_query)}'
    ...
    def test_search_artists(self):
        ...
        expected = f'https://musicbrainz.org/ws/2/artist/?query={quote_plus(expected_query)}'
        self.assertEqual(expected, self.last_url)
    ...
    def test_search_events(self):
        ...
        expected = f'https://musicbrainz.org/ws/2/event/?query={quote_plus(expected_query)}'
        self.assertEqual(expected, self.last_url)
    ...
    def test_search_labels(self):
        ...
        expected = f'https://musicbrainz.org/ws/2/label/?query={quote_plus(expected_query)}'
        self.assertEqual(expected, self.last_url)
    ...
    def test_search_places(self):
        ...
        expected = f'https://musicbrainz.org/ws/2/place/?query={quote_plus(expected_query)}'
        self.assertEqual(expected, self.last_url)
    ...
    def test_search_releases(self):
        ...
        expected = f'https://musicbrainz.org/ws/2/release/?query={quote_plus(expected_query)}'
    ...
    def test_search_release_groups(self):
        ...
        expected = f'https://musicbrainz.org/ws/2/release-group/?query={quote_plus(expected_query)}'
        self.assertEqual(expected, self.last_url)
    ...
    def test_search_recordings(self):
        ...
        expected = f'https://musicbrainz.org/ws/2/recording/?query={quote_plus(expected_query)}'
        self.assertEqual(expected, self.last_url)
    ...
    def test_search_works(self):
        ...
        expected = f'https://musicbrainz.org/ws/2/work/?query={quote_plus(expected_query)}'
        self.assertEqual(expected, self.last_url)
